...
public class JdbcTemplateWithResultSetExtractorCallBackInterfaceApplication {

	public static void main(String[] args) {
		ApplicationContext context = SpringApplication.run(JdbcTemplateWithResultSetExtractorCallBackInterfaceApplication.class, args);
